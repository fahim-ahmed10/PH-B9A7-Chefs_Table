        ...
        <div className='container mx-auto mt-5 px-2 flex flex-col md:flex-col lg:flex-row gap-10 md:gap-5 lg:gap-10'>
            <div className="md:w-[50%] lg:w-[65%] grid md:grid-cols-1 lg:grid-cols-2 self-center gap-5 md:gap-10 lg:gap-3">
                <div className='w-[379px] border p-6 rounded-2xl'>
                    ...
                    <button className='text-xl font-bold bg-[#0be58a] hover:bg-[#6cfbbf] px-5 py-3 rounded-3xl'>Want to Cook</button>
                </div>
                <div className='w-[379px] border p-6 rounded-2xl'>
                    <div>
                        <img src={bolognesePic} alt="bolognese" />
                ...
                <div className='w-full border rounded-2xl'>
                    ...
                    <div>
                        <table className='mt-3'>
                            <tr>
                                <td></td>
                                <td className='pb-4 pl-3 md:pr-10 lg:pr-20 w-[35%] lg:w-32 text-start'>Name</td>
                    ...
                    <div className='mb-5'>
                        <table className='mt-3'>
                            <tr>
                                <td></td>
                                <td className='pb-4 pl-3 md:pr-20 lg:pr-28 w-[35%] lg:w-32 text-start'>Name</td>
                                <td className='pb-4 md:pr-10 lg:pr-20 w-[25%] lg:w-20 text-start'>Time</td>
                            ...
                            <tr className='text-sm'>
                                ...
                                <td className='pr-4 pt-4'>Total Time = <br />45 minutes</td>
                                <td className='pr-4 pt-4'>Total calories = <br /> 400 calories</td>
                            </tr>
                        </table>
                    </div>
                </div>
